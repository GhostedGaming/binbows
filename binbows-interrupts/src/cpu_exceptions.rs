...
pub extern "x86-interrupt" fn divide_by_zero_handler(_stack_frame: InterruptStackFrame) {
    serial_println!("[ERROR] EXCEPTION: DIVIDE BY ZERO\r\n");
    serial_println!(
...
pub extern "x86-interrupt" fn general_protection_fault_handler(
    ...
    serial_println!("[ERROR] General Protection Fault: {:#?}\r\n", stack_frame);
    serial_println!("[ERROR] Error Code: {:#x}\r\n", error_code);
    serial_println!(
...
pub extern "x86-interrupt" fn non_maskable_interrupt_handler(stack_frame: InterruptStackFrame) {
    serial_println!("[NMI] Non-Maskable Interrupt: {:#?}\r\n", stack_frame);
    serial_println!(
...
pub extern "x86-interrupt" fn breakpoint_handler(stack_frame: InterruptStackFrame) {
    serial_println!("[DEBUG] Breakpoint Exception: {:#?}\r\n", stack_frame);
    serial_println!(
...
pub extern "x86-interrupt" fn overflow_handler(stack_frame: InterruptStackFrame) {
    serial_println!("[ERROR] Stack Overflow: {:#?}\r\n", stack_frame);
    serial_println!(
...
pub extern "x86-interrupt" fn bound_range_exceeded_handler(stack_frame: InterruptStackFrame) {
    serial_println!("[ERROR] Bound Range Exceeded: {:#?}\r\n", stack_frame);
    serial_println!(
...
pub extern "x86-interrupt" fn invalid_opcode_handler(stack_frame: InterruptStackFrame) {
    serial_println!("[ERROR] Invalid Opcode: {:#?}\r\n", stack_frame);
    serial_println!(
...
pub extern "x86-interrupt" fn device_not_available_handler(stack_frame: InterruptStackFrame) {
    serial_println!("[ERROR] Device Not Available: {:#?}\r\n", stack_frame);
    serial_println!(
...
pub extern "x86-interrupt" fn invalid_tss_handler(
    ...
    serial_println!("[ERROR] Invalid TSS: {:#?}\r\n", stack_frame);
    serial_println!("[ERROR] Error Code: {:#x}\r\n", error_code);
    serial_println!(
...
pub extern "x86-interrupt" fn segment_not_present_handler(
    ...
    serial_println!("[ERROR] Segment Not Present: {:#?}\r\n", stack_frame);
    serial_println!("[ERROR] Error Code: {:#x}\r\n", error_code);
    serial_println!(
...
pub extern "x86-interrupt" fn stack_segment_fault_handler(
    ...
    serial_println!("[ERROR] Stack Segment Fault: {:#?}\r\n", stack_frame);
    serial_println!("[ERROR] Error Code: {:#x}\r\n", error_code);
    serial_println!(
...
pub extern "x86-interrupt" fn page_fault_handler(
    ...
    serial_println!("[ERROR] Page Fault: {:#?}\r\n", stack_frame);
    serial_println!("[ERROR] Error Code: {:?}\r\n", error_code);
    serial_println!(
...
pub extern "x86-interrupt" fn alignment_check_handler(
    ...
    serial_println!("[ERROR] Alignment Check Exception: {:#?}\r\n", stack_frame);
    serial_println!("[ERROR] Error Code: {:#x}\r\n", error_code);
    serial_println!(
...
pub extern "x86-interrupt" fn simd_floating_point_handler(stack_frame: InterruptStackFrame) {
    ...
    serial_println!("[SUGGESTION] Possible cause: SIMD FPU error. Solution: Check SIMD operations.\r\n");
    loop {
        unsafe {
            asm!("cli; hlt");
        }
...
pub extern "x86-interrupt" fn virtualization_exception_handler(stack_frame: InterruptStackFrame) {
    serial_println!("[ERROR] Virtualization Exception: {:#?}\r\n", stack_frame);
    serial_println!(
